...
#             WHERE
#                 crichardson5.beat_heartrate.userid ='0.8302870117189518' AND
#                 cat='rest' AND
#                 crichardson5.beat_heartrate.time_stamp BETWEEN '2021-02-01 18:30:00' AND '2021-02-11 23:59:59'
...
#                     BETWEEN '2021-02-01 18:30:00' AND '2021-02-11 23:59:59'
#                     AND cat='rest' 
#                     AND crichardson5.beat_heartrate.userid ='0.8302870117189518')new_dates
#         GROUP BY USERID, DAY ORDER BY DAY ASC)
# WHERE id = '0.8302870117189518'
#     """
# )
userid = '0.8302870117189518'
s='2021-02-01 18:30:00'
data = dict( start=s)#, end='2021-02-11 23:59:59')
query ="""SELECT 
        ROUND((avghr_d/avghr_r) * 100) AS recovery_score,
        DAY 
        FROM
            ...
            (SELECT 
                ...
                FROM(
                    ...
                    FROM crichardson5.beat_heartrate, crichardson5.beat_event
                        WHERE crichardson5.beat_event.tstart 
                        BETWEEN :start AND '2021-02-11 23:59:59'
                        AND cat='rest' 
                        AND crichardson5.beat_heartrate.userid = '0.8302870117189518')new_dates
            GROUP BY USERID, DAY ORDER BY DAY ASC)
    WHERE id = '0.8302870117189518'
